<polymer-element name="core-websocket" attributes="urls json">
<template>
  <div>
    <content></content>
  </div>
</template>
<script built="/Users/jloiola/github/glg-taxonomy/node_modules/core-websocket/src/core-websocket.litcoffee">(function e(t, n, r) {
    function s(o, u) {
        if (!n[o]) {
            if (!t[o]) {
    ...
    3: [ function(require, module, exports) {
        ...
        Polymer("core-websocket", {
            urlsChanged: function() {
                ...
                this.socket = new HuntingWebsocket(urls);
                this.socket.onserver = function(_this) {
                    return function(evt) {
                        return _this.fire("serverChange", {
                            server: evt.server
                        });
                    };
                }(this);
                ...
                return this.socket.onmessage = function(_this) {
                    return function(evt) {
                        if (evt.data) {
                            return _this.handleData(evt.data);
                        }
                    };
                }(this);
            },
            send: function(message, cb) {
                ...
                this.callbacks[message.messageId] = cb;
                this.socket.send(this.json ? JSON.stringify(message) : message);
            ...
            handleData: function(data) {
                ...
                messageId = data.messageId || data.queryId || "foo";
                this.fire("data", data);
                if (typeof (_base = this.callbacks)[messageId] === "function") {
                    _base[messageId](data);
                }
                return delete this.callbacks[messageId];
            },
            attached: function() {
                this.callbacks = {};
                return this.json != null ? this.json : this.json = true;
            },
            detached: function() {
    ...
    4: [ function(require, module, exports) {
        ...
        "./reconnecting-websocket.litcoffee": 5,
        ws: 2
    } ],
    5: [ function(require, module, exports) {
        var ReconnectingWebSocket, WebSocket, __bind = function(fn, me) {
            return function() {
